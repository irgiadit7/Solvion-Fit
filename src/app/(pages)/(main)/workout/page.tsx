...
<div className="grid grid-cols-4 gap-8 border border-gray-600 p-4 rounded-2xl relative bg-zinc-800/40">
  ...
  <div className="[grid-column:1/span_1] [width:150%] bg-zinc-700 rounded-lg p-4 text-center">
    05
  </div>
                    ...
                    <div className="grid grid-cols-1 gap-8">
                        ...
                        <Link href="/workout/library">
                            <div className="relative bg-zinc-800 rounded-2xl shadow-lg overflow-hidden h-64 group">
                                {/* Video Element */}
                                {/* <video
                                    src="https://www.muscleandmotion.com/wp-content/uploads/2023/05/FinalBGblack-1.mp4"
                                    autoPlay
                                    loop
                                    muted
                                    playsInline
                                    className="absolute inset-0 w-full h-full object-cover z-0 opacity-50 group-hover:opacity-75 transition-opacity duration-300"
                                /> */}
                                {/* Content Overlay */}
